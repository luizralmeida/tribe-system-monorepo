...
exports.GetCompanionsUseCase = void 0;
...
let GetCompanionsUseCase = class GetCompanionsUseCase {
    guestRepository;
    ...
    async execute(input) {
        ...
        return companions.map(guest_response_dto_js_1.GuestResponseDto.fromDomain);
    }
};
exports.GetCompanionsUseCase = GetCompanionsUseCase;
exports.GetCompanionsUseCase = GetCompanionsUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(guest_repository_interface_js_1.GUEST_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], GetCompanionsUseCase);
//# sourceMappingURL=get-companions.use-case.js.map