...
exports.GetEventStatsUseCase = void 0;
...
let GetEventStatsUseCase = class GetEventStatsUseCase {
    eventRepository;
    constructor(eventRepository) {
        this.eventRepository = eventRepository;
    }
    async execute(input) {
        const isSuperUser = input.userRole === user_role_enum_js_1.UserRole.SUPER;
...
exports.GetEventStatsUseCase = GetEventStatsUseCase;
exports.GetEventStatsUseCase = GetEventStatsUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(event_repository_interface_js_1.EVENT_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], GetEventStatsUseCase);
//# sourceMappingURL=get-event-stats.use-case.js.map