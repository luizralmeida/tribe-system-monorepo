...
export declare class UserController {
    ...
    constructor(createUserUseCase: CreateUserUseCase, findUsersUseCase: FindUsersUseCase, findUserByIdUseCase: FindUserByIdUseCase, updateUserUseCase: UpdateUserUseCase, deleteUserUseCase: DeleteUserUseCase);
    create(dto: CreateUserDto): Promise<UserResponseDto>;
    findAll(query: PaginationQueryDto): Promise<PaginatedResponseDto<UserResponseDto>>;
